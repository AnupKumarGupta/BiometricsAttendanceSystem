    ...
    public List<Employees> GetAllEmployees()
    {
        ...
        using (DBDataHelper objDDBDataHelper = new DBDataHelper())
        {
            ...
            foreach (DataRow rows in ds.Tables[0].Rows)
            {
                ...
                objEmployee.JoiningDate = ds.Tables[0].Rows[i][3] == DBNull.Value ? new DateTime() : Convert.ToDateTime(ds.Tables[0].Rows[i][4]);
                objEmployee.ImagePath = ds.Tables[0].Rows[i][4] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][5].ToString();
                objEmployee.ContactNumber = ds.Tables[0].Rows[i][5] == DBNull.Value ? new Int64() : Convert.ToInt64(ds.Tables[0].Rows[i][6]);
                objEmployee.Password = ds.Tables[0].Rows[i][6] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][7].ToString();
                objEmployee.DepartmentId = ds.Tables[0].Rows[i][7] == DBNull.Value ? new Int32() : Convert.ToInt32(ds.Tables[0].Rows[i][8]);
                objEmployee.DepartmentName = ds.Tables[0].Rows[i][8] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][9].ToString();
                objEmployee.RoleId = ds.Tables[0].Rows[i][9] == DBNull.Value ? new Int32() : Convert.ToInt32(ds.Tables[0].Rows[i][10]); ;
                objEmployee.RoleName = ds.Tables[0].Rows[i][10] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][11].ToString();
                objEmployee.WeeklyOffDay = ds.Tables[0].Rows[i][11] == DBNull.Value ? 1 : Convert.ToInt32(ds.Tables[0].Rows[i][12]);
    ...
    public List<Employees> GetAllEmployees()
    {
        ...
        using (DBDataHelper objDDBDataHelper = new DBDataHelper())
        {
            ...
            foreach (DataRow rows in ds.Tables[0].Rows)
            {
                ...
                objEmployee.DepartmentId = ds.Tables[0].Rows[i][7] == DBNull.Value ? new Int32() : Convert.ToInt32(ds.Tables[0].Rows[i][7]);
                objEmployee.DepartmentName = ds.Tables[0].Rows[i][8] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][8].ToString();
                objEmployee.RoleId = ds.Tables[0].Rows[i][9] == DBNull.Value ? new Int32() : Convert.ToInt32(ds.Tables[0].Rows[i][9]); ;
                objEmployee.RoleName = ds.Tables[0].Rows[i][10] == DBNull.Value ? "NULL" : ds.Tables[0].Rows[i][10].ToString();
