<%@ Page Title="Attendance Detail" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="DetailedDailyAttendanceReport.aspx.cs" Inherits="Reports_DetailedDailyAttendanceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <title>DetailedDailyAttendanceReport</title>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col s12 breadcrumb">
                    ...
                    <a href="#!" class="teal-text">&nbsp;&nbsp;Daily Attendance Detailed &nbsp;&nbsp;</a>
                </div>
                ...
                <div class="col s12 m2 l0 offset-l5 offset-m4">
                    <asp:DropDownList ID="ddlRelaxation" Visible="true" CssClass="input-field btn grey col s12 lighten-5 teal-text" runat="server">
