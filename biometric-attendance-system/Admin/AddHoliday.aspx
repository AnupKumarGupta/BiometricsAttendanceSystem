        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col s4 m4 l4 offset-s1 offset-m1 offset-l1 card">
                    ...
                    <div class="row">
                        <asp:TextBox ID="txtHoliday" placeholder="Name of Holiday" CssClass="input-field col l5 m5 s5" runat="server">
                        </asp:TextBox>
                        <asp:DropDownList runat="server" ID="ddlStatus" CssClass="input-field btn teal white-text col l5 m5 s5 offset-s2 offset-m2 offset-l2">
                            <asp:ListItem Text="Holiday" Value="1" />
                            <asp:ListItem Text="Weekly Off" Value="2" />
                        </asp:DropDownList>
                    </div>
                    <div class="row">
                        <div class="col s4 m4 l4 offset-s3 offset-m3 offset-l3">
